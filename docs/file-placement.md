...
> [!IMPORTANT]
> 本ドキュメントは vibecorp を導入したリポジトリにおける、各ディレクトリの役割と配置基準を定義する。
> 前提知識: `docs/design-philosophy.md`（3層アーキテクチャ）。
...
- 設計思想・3層アーキテクチャの根拠: `docs/design-philosophy.md`
- コーディング規約: `.claude/rules/`
- エージェント宣言: `.claude/agents/`
